...
WebUI.setText(findTestObject('LoginObject/input_Password_password'), 'admin1234')

WebUI.click(findTestObject('LoginObject/button_Login'))

WebUI.verifyElementText(findTestObject('LoginObject/login-error-message'), 'Invalid credentials')
